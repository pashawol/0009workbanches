			...
			<footer class="footer block-with-lazy">
				<div class="container">
					<div class="footer__row row"> 
							...
							<div class="footer__menu">
								<div class="row">
									<div class="col-xl-auto">
										<ul>
											<li><a class="strong" href="#"> Каталог </a></li>
						...
						<div class="col-lg-auto col-sm order-sm-first"><a class="footer__logo" href="#"><img class="res-i lazy" src="#" data-src="img/@2x/logo.png" alt=""/></a>
