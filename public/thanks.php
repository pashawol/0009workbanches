...
<html lang="ru">
	...
	<body><!--[if lt IE 11]><p   class="browsehappy container">К сожалению, вы используете устаревший браузер. Пожалуйста, <a href="http://browsehappy.com/" target="_blank">обновите ваш браузер</a>, чтобы улучшить производительность, качество отображаемого материала и повысить безопасность.</p><![endif]-->
		...
		<div class="d-none">
			...
			<!-- Аксессуары-->
			<div class="modal-header-block modal-header-block--accessories modal-white-close" id="modal-accessories"><img class="res-i" src="img/@2x/modal-accessories.jpg" alt=""/>
				<h4>Каждый верстак оснащен перфорированным экраном,</h4>
				<p>Коврик резиновый, экран, держатель для свёрл, полку малую, полку большую, контейнер для мелочей, карман для чертежей, держатель отвёрток и&nbsp;ключей, крючок для инструмента</p>
			</div>
			<!-- Столешница-->
			<div class="modal-header-block modal-accessories modal-white-close" id="countertop"><img class="res-i" src="img/@2x/modal-accessories.jpg" alt=""/>
				<h4>Каждый верстак оснащен перфорированным экраном,</h4>
				<p>Коврик резиновый, экран, держатель для свёрл, полку малую, полку большую, контейнер для мелочей, карман для чертежей, держатель отвёрток и&nbsp;ключей, крючок для инструмента</p>
			</div>
			<!-- modal-->
