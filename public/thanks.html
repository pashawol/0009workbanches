...
<html lang="ru">
	...
	<body><!--[if lt IE 11]><p   class="browsehappy container">К сожалению, вы используете устаревший браузер. Пожалуйста, <a href="http://browsehappy.com/" target="_blank">обновите ваш браузер</a>, чтобы улучшить производительность, качество отображаемого материала и повысить безопасность.</p><![endif]-->
		...
		<div class="d-none">
			...
			<!-- Резиновый коврик-->
			<div class="modal-header-block modal-mat" id="modal-mat"><img class="res-i lazy" src="#" data-src="img/@2x/modal-mat.jpg" alt=""/>
			...
			<div class="modal-header-block modal-guides" id="modal-guides"><img class="res-i lazy" src="#" data-src="img/@2x/modal-guides.jpg" alt=""/>
			...
			<!-- Экран-->
			<div class="modal-header-block modal-display" id="modal-display"><img class="res-i lazy" src="#" data-src="img/@2x/modal-display.jpg" alt=""/>
				<h4>Каждый верстак оснащен перфорированным экраном,</h4>
				<p>для размещения дополнительных запчастей, инструментов, документов</p>
			</div>
			<!-- Аксессуары-->
			<div class="modal-header-block modal-accessories" id="modal-accessories"><img class="res-i lazy" src="#" data-src="img/@2x/modal-accessories.jpg" alt=""/>
				<h4>Каждый верстак оснащен перфорированным экраном,</h4>
